...
adjusted for multiplicity via `stats::p.adjust()` (Bonferroni, Holm
or Benjamini–Hochberg, selected by the `p_adjust_method` argument).
A compact letter display is then computed from the adjusted *p*-values
with `multcompView::multcompLetters()`.
